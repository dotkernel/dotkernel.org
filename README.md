...
**Dotkernel.org** is designed to be a presentation site for **Dotkernel API**, the core part of Dotkernel Headless Platform,  based on Enrico Zimuel's Zend Expressive API - Skeleton example.
